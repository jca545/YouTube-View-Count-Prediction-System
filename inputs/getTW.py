...
# ==========================
CHANNEL_IDS = [
    "UC3ePO05Z8DUw-w9F59p5Mjg"  # TODO: (change) Liver's channel ID
]

BASE_OUTPUT_NAME = "Kimberley"  # (optional change) filename 
STYLE = "TW"                    # HERE: (change) style

# Duration limits in seconds
MIN_DURATION_SEC = 60 * 1.5  # 2 minute
MAX_DURATION_SEC = 60 * 8  # 7 minutes

unwanted_keywords = [
    "promotional video", "pv", "teaser", "tralier", "trailer", 
    "預告片", "預告", "宣傳", "廣告", "幕後", "花絮", "片花", "vlog",
    "ep ", " ep", "album", "reaction",
    "highlight", "Movie", "配信", "動画", "漫画", "練習用", "対談"
    "behind the scenes", "after movie", "making behind", "演後", 
    "POPUP SHOP"
]
...
# KEYWORDS 
# ==========================
DANCE = ['dance', 'choreography', '編舞', '舞蹈']
REMIX = ['remix']
LANG = ['ver.', ' ver ', 'edit', 'clip', '版】']
COVER = ['cover', '歌ってみた', ' 歌いました', '翻唱']
MV = ['official', 'original', 'mv', 'm.v', 'music video', 'musicvideo', 
      'official mv', 'official m/v', 'original mv', 'original song', 
      'original sound', 'special clip', 'オリジナル', '原創', 'acoustic']
LYRIC = ['lyric video', 'lyrics', 'lyric', '歌詞版']
LIVE = ['live', 'live ver', 'live video', 'live clip', 'episode',
        'performance', 'special edit', 'cam',
        'stage', '公演', '演唱會', '音樂會', 'tour', 'festival', 'fanfest', ' at ']
