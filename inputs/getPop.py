...
# ==========================
CHANNEL_IDS = [
    "UCqwUnggBBct-AY2lAdI88jQ"  # TODO: (change) Singer's channel ID
]

BASE_OUTPUT_NAME = "BABYMONSTER"# (optional change) filename 
STYLE = "KPop"                  # HERE: (change) style
...
unwanted_keywords = [
    "promotional video", "pv", "teaser", "tralier", "trailer", "預告片", 
...
# KEYWORDS 
# ==========================
DANCE = ['dance', 'choreography', '編舞']
REMIX = ['remix']
LANG = ['ver.', ' ver ', 'edit', 'clip']
COVER = ['cover', '歌ってみた', ' 歌いました']
