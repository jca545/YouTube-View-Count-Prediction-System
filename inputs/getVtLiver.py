...
# ==========================
CHANNEL_IDS = [
    "UC9LF4J85zAG-6T-OjpcezOA"  # TODO: (change) Liver's channel ID
]

BASE_OUTPUT_NAME = "Moondogs"   # (optional change) filename 
STYLE = "vTubers"               # HERE: (change) style

# Duration limits in seconds
MIN_DURATION_SEC = 60 * 2  # 1 minute
MAX_DURATION_SEC = 60 * 7  # 6 minutes
...
COVER = ['ver.', 'ver', 'cover', '歌ってみた']
MV = ['official', 'original', 'mv', 'music video', 'musicvideo', 
      'official mv', 'official m/v', 'original mv', 'original song', 
      'original sound', 'special clip', 'オリジナル', '原創']
LYRIC = ['lyric video', 'lyrics', 'lyric']
LIVE = ['live', 'live ver', 'live video', 'live clip', 
        'performance', 'special edit', 'stage', '公演']
